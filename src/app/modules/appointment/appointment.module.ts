...
@NgModule({
  ...
  declarations: [ListComponent,ConsumptionComponent, PreviewComponent,  AppointSettingComponent, SwimmerSettingComponent, BaseComponent, BydayComponent, ConfigComponent, ConfigureComponent, RuleComponent, SwimBydayComponent, SwimBaseComponent],
